...
env = ChessEnv(opponent='stockfish')
agent = DQN(env=env)
agent.learn(3, time_out=100, checkpoint_folder_path="ChessRL/model_saved/dqn")
...
env = ChessEnv(opponent='stockfish')
agent = DDQN(env=env)
agent.learn(3, time_out=100, checkpoint_folder_path="ChessRL/model_saved/ddqn")
...
agent.learn(3, time_out=100, checkpoint_folder_path="ChessRL/model_saved/dqn_carlsen_warmup")
...
agent.learn(3, time_out=100, checkpoint_folder_path="ChessRL/model_saved/ddqn_carlsen_warmup")
...
agent.learn(3, time_out=100, checkpoint_folder_path="ChessRL/model_saved/dqn_berliner_warmup")
...
agent.learn(3, time_out=100, checkpoint_folder_path="ChessRL/model_saved/ddqn_berliner_warmup")
...
agent.learn(3, time_out=100, checkpoint_folder_path="ChessRL/model_saved/dqn_modern")
...
agent.learn(3, time_out=100, checkpoint_folder_path="ChessRL/model_saved/dqn_engsym")
